 ...
 * @author karamdeep singh
 * Student number:991722253
 */
public class CardTrick {
    ...
    public static void main(String[] args) {
        ...
        if (found) {
            System.out.println("The lucky card (6 of SPADES) is in the magic hand. You win!");
        } else {
            System.out.println("The lucky card (6 of SPADES) is not in the magic hand. You lose.");
        }
    }
}
